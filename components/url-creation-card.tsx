...
function CountryRedirectsBuilder({
    ...
    const [rules, setRules] = useState<
        Array<{ countries: string[]; target: string }>
    >([]);
            ...
            if (parsed) {
                if (Array.isArray(parsed.countryRedirects)) {
                    next = parsed.countryRedirects.map((r: any) => ({
                        countries: (
                            r.countries || (r.country ? [r.country] : [])
                        ).map((c: string) => c.toUpperCase()),
                        target: r.target || r.value || r || "",
                    }));
                } else if (
                    parsed.countryRedirects &&
                    typeof parsed.countryRedirects === "object"
                ) {
                    next = Object.entries(parsed.countryRedirects).map(
                        ([k, v]) => ({
                            countries:
                                k === "*" || k === "default"
                                    ? ["*"]
    ...
    function updateRule(
        index: number,
        patch: Partial<{ countries: string[]; target: string }>,
    ) {
        setRules((s) =>
            s.map((r, i) => (i === index ? { ...r, ...patch } : r)),
        );
    }
        ...
        <div>
            ...
            <div className="mt-3 space-y-3">
                {rules.length === 0 && (
                    <div className="text-sm text-muted-foreground">
                        No rules defined. Use the buttons above to add a rule or
                        insert an example.
                    </div>
                )}
                ...
                {rules.map((r, idx) => (
                    ...
                    >
                        ...
                        <Input
                            ...
                            value={r.target}
                            onChange={(e) =>
                                updateRule(idx, { target: e.target.value })
                            }
                        ...
                        <Button
                            // type="button"
                            // className="col-span-1 inline-flex items-center justify-center text-destructive hover:bg-muted/30 rounded p-1"
                            size={"icon"}
                            variant={"outline"}
            ...
            {/* <div className="mt-4">
                ...
                <div className="flex items-center justify-between mt-2">
                    <FieldDescription>
                        JSON is kept in sync with the visual rules. Edit raw
                        JSON to import custom shapes.
                    </FieldDescription>
                    {jsonError && (
        ...
        <Card className="w-full mx-auto shadow-lg border border-border/60">
            <CardHeader className="pb-2">
                ...
                <CardDescription className="text-base text-muted-foreground">
                    Paste your long link, customize, and track performance.
                    Advanced options are available for power users.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <form
                ...
                >
                            ...
                            children={(field) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <FieldDescription>
                                            Paste the full URL you want to
                                            shorten.
                                        </FieldDescription>
                                        {isInvalid && (
                                            <FieldError
                            ...
                            children={(field) => {
                                ...
                                return (
                                    <Field data-invalid={isInvalid}>
                                        ...
                                        <FieldDescription>
                                            Optional: Give your link a name for
                                            easy reference.
                                        </FieldDescription>
                                        {isInvalid && (
                                            <FieldError
                            ...
                            children={(field) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <FieldDescription>
                                            Optional: Add details about this
                                            link's purpose or audience.
                                        </FieldDescription>
                                        {isInvalid && (
                                            <FieldError
                                                errors={field.state.meta.errors}
                    ...
                    <FieldGroup>
                        ...
                        <details className="rounded-md bg-card-foreground/[0.03] px-4 py-3 mt-2">
                        ...
                        <details className="rounded-md bg-card-foreground/[0.03] px-4 py-3">
                            <summary className="cursor-pointer font-medium text-sm text-foreground/90 select-none flex items-center gap-2">
